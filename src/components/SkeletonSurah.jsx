...
function SkeletonSurah({ className = "" }) {
  return (
    <>
      <button
        className={`w-[26rem] h-[3.65rem] lg:h-[4.6rem] p-3 font-normal text-[0.7rem] lg:text-[1rem] active:scale-[0.98] transall duration-200 flexc rounded shadow bg-primary ${className}`}
      >
        {/* --------------- */}
